...
if __name__ == "__main__":
    ...
    plot_output_path = "Hepatitis\\plots_and_tables\\knn_base\\statistical_analysis_results.png"
    report_output_path = "Hepatitis\\plots_and_tables\\knn_base\\statistical_analysis_report.txt"

alpha = 0.2  # Set significance level
main(csv_path, plot_output_path, report_output_path, alpha)
print(f"Results saved in file Hepatitis/plots_and_tables/knn_base/statistical_analysis_report.txt\n")